...
class CmdBlah(Command):
    ...
    def func(self):
        self.caller.msg("You have used the special menu command!")

class CmdGurpsCharCreate(CmdCharCreate):
    def func(self):
        ...
        print(f"Right hand side is {self.rhs}")
        description = self.rhs or "This is a character."

        start_chargen(self.account, self.session, {"name": key, "description":description})
